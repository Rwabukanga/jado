...
import com.Solar.SolarEnergy.Dao.PaymentRepository;
import com.Solar.SolarEnergy.Dao.Paymentdao;
...
@Service
public class PaymentImplemenation implements PaymentService {
	...
	public Payment findByUuid(String uuid) {
		...
		return paymentdao.findByUuid(uuid);
	}
	...
	public List<Payment> findAll() {
		// TODO Auto-generated method stub
		return paymentdao.findAll(Payment.class);
	}

	@Override
	public Payment findAllbyPayment(long id) {
		// TODO Auto-generated method stub
		return paymentdao.findAllbyPayment(id);
	}
	...
	public byte[] PaymentDetailsPDF(Payment pay) {
	    ...
	    try {
	        ...
	        Chunk title = new Chunk("Payment Request Summary", font);
...
//			tTitle.setColspan(1);
	        ...
	        bid.add(new Chunk(pay.getContract().getOrder().getSolarenergy().getBranch().getBranchname(),new Font(FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
	        ...
	        bn.add(new Chunk(pay.getContract().getOrder().getSolarenergy().getBranch().getPhonenumber(),new Font(FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
	        ...
	        ba.add(new Chunk(pay.getContract().getOrder().getSolarenergy().getBranch().getProvince().getName(),new Font(FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
	     
	        
	        bp.add(new Chunk("E-mail: ",new Font(FontFamily.HELVETICA, 10, Font.BOLD, BaseColor.BLACK)));
	        bp.add(new Chunk(pay.getContract().getOrder().getSolarenergy().getBranch().getEmail(),new Font(FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
	        ...
	        sid.add(new Chunk(pay.getContract().getOrder().getRegistrar().getIdnumber()+"",new Font(FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
	        ...
	        sn.add(new Chunk(pay.getContract().getOrder().getRegistrar().getFirstname()+" "+ pay.getContract().getOrder().getRegistrar().getLastname(),new Font(FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
	        ...
	        sa.add(new Chunk(pay.getContract().getOrder().getRegistrar().getDistrict().getProvince().getName()+ ","+pay.getContract().getOrder().getRegistrar().getDistrict().getName()+"",new Font(FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
	        Paragraph spAddress = new Paragraph();
	        spAddress.add(sa);
	       
	        sp.add(new Chunk("Phone: ",new Font(FontFamily.HELVETICA, 10, Font.BOLD, BaseColor.BLACK)));
	        sp.add(new Chunk(pay.getContract().getOrder().getRegistrar().getPhonenumber(),new Font(FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
	        ...
	        Paragraph p1=new Paragraph("Payment Details",new Font(FontFamily.HELVETICA, 15, Font.BOLD, BaseColor.BLACK));
...
//			table.addCell(praCell(new Paragraph("Requested Delivery Date",new Font(FontFamily.TIMES_ROMAN, 10, Font.BOLD, BaseColor.BLACK)))).setBorderColor(BaseColor.BLACK);
	       ...
	       /* table.addCell(praCell(new Paragraph("Closing Date",new Font(FontFamily.TIMES_ROMAN, 10, Font.BOLD, BaseColor.BLACK)))).setBorderColor(BaseColor.BLACK);
	        ...
	        table.addCell(praCell(new Paragraph("Contract Name",new Font(FontFamily.TIMES_ROMAN, 10, Font.BOLD, BaseColor.BLACK)))).setBorderColor(BaseColor.BLACK);
	        table.addCell(praCell(new Paragraph(pay.getContract().getOrder().getRegistrar().getFirstname()+" "+pay.getContract().getOrder().getRegistrar().getLastname()+"",new Font(FontFamily.TIMES_ROMAN, 10, Font.NORMAL, BaseColor.BLACK))));
	        ...
	        table.addCell(praCell(new Paragraph(pay.getAmount()+"",new Font(FontFamily.TIMES_ROMAN, 10, Font.NORMAL, BaseColor.BLACK))));
	        table.addCell(praCell(new Paragraph("PaymentStatus",new Font(FontFamily.TIMES_ROMAN, 10, Font.BOLD, BaseColor.BLACK)))).setBorderColor(BaseColor.BLACK);
	        table.addCell(praCell(new Paragraph(pay.getPaymentstatus()+"",new Font(FontFamily.TIMES_ROMAN, 10, Font.NORMAL, BaseColor.BLACK))));
